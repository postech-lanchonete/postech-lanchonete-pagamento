...
import br.com.postech_lanchonete_pagamento.adapters.repositories.PagamentoRepository;
...
import static br.com.postech_lanchonete_pagamento.stub.PagamentoStub.createPagamentoDocument;
...
//    }
    ...
    void buscarPorId_deveRetornarPagamento_quandoIdInformadoExistente() throws Exception {
        ...
        mockMvc.perform(get("/v1/pagamentos/" + document.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
